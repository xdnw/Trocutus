...
public class DBMain implements Closeable {
    private boolean isDelegate;
    private final Database db;
    public DBMain(String name) throws SQLException {
        this(Settings.INSTANCE.DATABASE, name);
    }

    public DBMain(Settings.DATABASE config, String name) throws SQLException {
    ...
    public DBMain(File file) throws SQLException {
        this.db = Database.connect(file);
        init();
    }

    public DBMain(String host, int port, String name, String username, String password) throws SQLException {
        this.db = Database.connect(host, port, name, username, password);
        init();
    }

    public DBMain(Database other) {
        this.db = other;
