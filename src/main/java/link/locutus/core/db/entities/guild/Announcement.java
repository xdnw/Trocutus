package link.locutus.core.db.entities.guild;
...
public class Announcement {
    ...
    public static class PlayerAnnouncement {
        ...
        public final int receiverKingdom;
        public final boolean active;

        public PlayerAnnouncement(GuildDB db, Announcement parent, byte[] diff, int receiverKingdom, boolean active) {
            this.db = db;
            this.parent = parent;
        ...
        public PlayerAnnouncement(GuildDB db, Announcement ann, ResultSet rs) throws SQLException {
            ...
            this.receiverKingdom = rs.getInt("receiver");
