...
public class CM {
    ...
    public static class war{
        public static class find{
            ...
            public static class raid extends CommandRef {
                ...
                public raid create(String realm, String numResults, String sortGold, String sortLand, String ignoreLosses, String ignoreDoNotRaid) {
                    return createArgs("realm", realm, "numResults", numResults, "sortGold", sortGold, "sortLand", sortLand, "ignoreLosses", ignoreLosses, "ignoreDoNotRaid", ignoreDoNotRaid);
                }
            }
            ...
            public static class intel extends CommandRef {
                ...
                public intel create(String realm, String numResults, String noAlliance, String inactive, String skipSpiedAfterLogin, String ignoreDoNotRaid) {
                    return createArgs("realm", realm, "numResults", numResults, "noAlliance", noAlliance, "inactive", inactive, "skipSpiedAfterLogin", skipSpiedAfterLogin, "ignoreDoNotRaid", ignoreDoNotRaid);
                }
            }
        }
    }
    ...
    public static class spyop extends CommandRef {
        ...
        public spyop create(String realm, String numResults, String noAlliance, String inactive, String skipSpiedAfterLogin, String ignoreDoNotRaid) {
            return createArgs("realm", realm, "numResults", numResults, "noAlliance", noAlliance, "inactive", inactive, "skipSpiedAfterLogin", skipSpiedAfterLogin, "ignoreDoNotRaid", ignoreDoNotRaid);
        }
    }
    ...
    public static class fey{
        ...
        public static class optimal extends CommandRef {
            ...
            public optimal create(String my_score, String my_attack) {
                return createArgs("my_score", my_score, "my_attack", my_attack);
            }
        }
        ...
        public static class land extends CommandRef {
            ...
            public land create(String myLand, String attack) {
                return createArgs("myLand", myLand, "attack", attack);
            }
        }
    }
