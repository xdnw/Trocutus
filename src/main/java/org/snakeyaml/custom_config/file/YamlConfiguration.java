package org.snakeyaml.custom_config.file;

import org.snakeyaml.custom_config.Configuration;
import org.snakeyaml.custom_config.ConfigurationSection;
import org.snakeyaml.custom_config.InvalidConfigurationException;
    ...
    protected String buildHeader() {
        ...
        if (options().copyHeader()) {
            ...
            if (def != null && def instanceof FileConfiguration) {
                final String defaultsHeader = ((FileConfiguration) def).buildHeader();
